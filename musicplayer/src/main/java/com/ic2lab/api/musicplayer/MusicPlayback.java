...
/**
 * Interface representing either Local or Remote MusicPlayback. The {@link MusicService} works
...
interface MusicPlayback {
     ...
     * @param item to play
     */
    void play(@Nullable QueueItem item);
    ...
    interface Callback {
        ...
        /**
         * on MusicPlayback status changed
